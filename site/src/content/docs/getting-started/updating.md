---
title: Updating
description: Bumping the DuckDB target version for the extension.
---
...
- Bump submodules
  ...
  - `./extension-ci-tools` should be set to updated branch corresponding to latest DuckDB release. So if you're building for DuckDB `v1.5.2` there will be a branch in `extension-ci-tools` named `v1.5.2` to which you should check out. 
