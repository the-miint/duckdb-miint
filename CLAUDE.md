...
- **Compile-time features** detected by querying the built extension (e.g., `HDF5_AVAILABLE`, `VSEARCH_AVAILABLE`, `MAFFT_AVAILABLE`, `ST3_AVAILABLE` — each checks for a registered function or library entry)
