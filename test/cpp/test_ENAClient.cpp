...
// Build a minimal single-row TSV response with a name-parsed subset of BATCH_FIELDS
// (deliberately omits fastq_md5, which these cache/grouping tests don't exercise).
