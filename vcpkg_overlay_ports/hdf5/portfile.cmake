# Overlay port based on vcpkg/ports/hdf5 version 1.14.6.
# The ONLY modification vs upstream is the addition of emscripten-fenv.patch,
# which guards FE_INVALID usage for Emscripten (fixed upstream in HDF5 2.0.0,
# see HDFGroup/hdf5#4952). When upgrading vcpkg's hdf5 port, sync all files
# here and verify the patch still applies. Remove this overlay entirely once
# vcpkg ships HDF5 >= 2.0.0.
#
